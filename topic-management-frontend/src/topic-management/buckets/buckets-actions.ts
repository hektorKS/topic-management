...
export enum BucketsActions {
  ...
  BUCKET_VIEW_OPENED = '[Bucket] Single bucket view opened',
...
export const singleBucketViewOpened = createAction(BucketsActions.BUCKET_VIEW_OPENED, props<{ bucketId: string }>());
